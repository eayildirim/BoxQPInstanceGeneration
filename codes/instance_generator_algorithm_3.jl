...
This code generates an instance of (BoxQP) by using Algorithm 3 in Qiu and Yildirim (2023) and solves that instance by CPLEX.

The instance generated has an exact SDP-RLT relaxation and a known optimal solution.
...
function algorithm_three_instances(n_1,seed_1,tim_lim)
